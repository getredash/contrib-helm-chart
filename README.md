...
| envSecretName                             | string | `nil`                                              | Contents of this secret will be loaded as environment variables - applied to both server and worker containers. Useful e.g. to set PostgreSQL password in externalPostgreSQL paramater.           |
